...
<div class="container">
    ...
    <div class="grid">
        <div class="content">
                ...
                <p>Resolution : $pro_res @$pro_fps FPS </p>
                <p>Software Used : $pro_soft</p>
                <p><b>Description : $pro_desc</b></p>
                <a href='index.php' class='btn btn-light mb-2 mr-2'>Go Back</a>
                <a href='details.php?add_cart=$pro_id'><button class='btn btn-success mb-2' id='cart'>Add to Cart</button></a>
                ...
                if(isset($_GET['add_cart'])){
                    ...
                    if(mysqli_num_rows($run_check)>0){
                       ...
                       if($run_pro>0){
                       echo "<script>alert('Item added to cart Go to home page');
                       window.open('details.php?pro_id=$pro_id','_self');
