    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="#"><span class="badge pull-left">4 Cart </span><i class="fa fa-shopping-cart"></i></a></li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    </div>
        ...
        <div class="content">
                ...
                <div class="col-md-8 wh"> 
                    ...
                    <table class="table table-striped table-dark">
                        ...
                        <th class="text-success">Product(S)</th>
                        ...
                        <?php } } ?>
                            ...
                            <tr align="right"> 
                                    <td ></td>
                                    <td ></td>
                                    <td><span class='animetxt' style='text-decoration: line-through; color:red;'>Sub Total: <?php echo '&#8377;' . $total; ?> </span> <div class='price' style="font-size : 26px; color: white;"> Rs. 0</div></td>
